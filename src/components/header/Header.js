  ...
  return (
    ...
    <div className='container py-1.5 mx-auto block space-y-3 sm:flex items-center justify-between '>
      <div className='flex items-center space-x-4 justify-center md-10'>
        <Link
          to='/maruti-suzuki-car-offers-page'
          className='uppercase text-white px-5 py-3 rounded-full shadow-sm text-sm bg-blue-800 hover:border-red-700 hover:bg-red-700 hover:text-white'
        >
          Offers
        </Link>
        <Link
          to='/maruti-car-service-centers-near-me'
          className='uppercase  border border-blue-800 px-4 py-3 rounded-full shadow-sm text-sm text-blue-800 bg-white hover:border-red-700 hover:bg-red-700 hover:text-white'
        >
          Service your car
        </Link>
        {/* </div> */}
