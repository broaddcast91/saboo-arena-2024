...
function Ertiga() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Maruti Ertiga On Road Price in Secunderabad, Hyderabad & 2024 Offers
        </title>
        <meta
          name='title'
          content='Maruti Ertiga On Road Price in Secunderabad, Hyderabad & 2024 Offers'
        />
        <meta
          name='description'
        ...
        <div className='my-auto'>
          ...
          <div className='flex items-center flex-wrap mt-5 text-blue-800 '>
            ...
            <div className='flex items-center space-x-3 mr-7'>
              ...
              <p className='text-sm'>
                Mileage <br />
                <span className='font-semibold'>20.51 kmpl*</span>
              </p>
            </div>
