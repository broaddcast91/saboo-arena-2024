...
function Eeco() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Maruti Eeco On Road Price in Secunderabad, Hyderabad & 2024 Offers
        </title>
        <meta
          name='title'
          content='Maruti Eeco On Road Price in Secunderabad, Hyderabad & 2024 Offers'
        />
        <meta
          name='description'
      ...
      <div className='container mx-auto grid grid-cols-1 sm:grid-cols-2 gap-5 my-8 sm:px-0 px-5'>
        ...
        <div className='my-auto'>
          ...
          <p className='font-semibold'>
            Ex-Showroom Price
            <span className='text-red-600 ml-3'>₹&nbsp;5.32 - 8.32 Lakh*</span>
          </p>
