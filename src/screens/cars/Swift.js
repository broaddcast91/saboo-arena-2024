...
function Swift() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Maruti Swift on Road Price in Secunderabad, Hyderabad & 2024 Offers
        </title>
        <meta
          name='title'
          content='Maruti Swift on Road Price in Secunderabad, Hyderabad & 2024 Offers'
        />
        <meta
          name='description'
        ...
        <div className='my-auto'>
          <div className='flex flex-col items-center sm:flex-row sm:items-start'>
            <p className='text-3xl font-light mb-2 sm:mb-0 sm:mr-4 text-blue-800'>
              Maruti Suzuki <span className='font-semibold'>Swift</span>
            </p>
            <img
          ...
          <div className='flex items-center flex-wrap mt-5 text-blue-800'>
            ...
            <div className='flex items-center space-x-3 mx-3 mb-1'>
              ...
              <p className='text-sm'>
                Mileage <br />
                <span className='font-semibold'>22.56 kmpl*</span>
              </p>
            </div>
