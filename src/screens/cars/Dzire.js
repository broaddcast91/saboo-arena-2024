...
function Dzire() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Maruti Dzire On Road Price in Secunderabad, Hyderabad & 2024 Offers
        </title>
        <meta
          name='title'
          content='Maruti Dzire On Road Price in Secunderabad, Hyderabad & 2024 Offers'
        />
        <meta
          name='description'
...
const CarsSlider = ({ scrollToCarEnquiry }) => {
  ...
  useEffect(() => {
    if (submitted) {
      document.getElementById('dzirePopup').submit();
    }
  }, [submitted]);
        ...
        <div className='my-auto'>
          <div className='flex flex-col items-center sm:flex-row sm:items-start'>
            <p className='text-3xl font-light mb-2 sm:mb-0 sm:mr-4 text-blue-800'>
              Maruti Suzuki <span className='font-semibold'>Dzire</span>
            </p>
            <img
          ...
          <div className='flex items-center flex-wrap mt-5 text-blue-800'>
            ...
            <div className='flex items-center space-x-3 mx-3 mb-1'>
              ...
              <p className='text-sm'>
                Mileage <br />
                <span className='font-semibold'>22.61 kmpl*</span>
              </p>
            </div>
    ...
    <div className='container mx-auto bg-gray-100 rounded-3xl mt-16 py-8 flex flex-col items-center'>
      ...
      <div className='flex items-center justify-center space-x-3 sm:space-y-0 space-y-1'>
        ...
        <p
          className={
            current === 7
              ? 'h-5 rounded-full w-5 bg-[#0f0f0f] animate-bounce'
