                ...
                <form ref={form} onSubmit={sendEmail}>
                  <div className='space-y-4'>
                    ...
                    <div className='flex justify-center space-x-2'>
                      <button
                        className='bg-blue-700 hover:bg-red-800 text-white py-3 px-5 rounded-full transition duration-300'
                        type='submit'
                        value='Send'
                      >
                        Submit
                      ...
                      <button
                        className='bg-gray-300 hover:bg-gray-400 text-gray-700 py-3 px-5 rounded-full ml-2 transition duration-300'
                        type='button'
                        onClick={handleReset}
                      >
                        Reset
