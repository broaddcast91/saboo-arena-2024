...
const BookMarutiService = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios
        .post('https://arena-backend-zj42.onrender.com/service', {
          name: name,
          phone: phone,
          email: email,
                ...
                <div className='ml-2  text-xs'>
                  ...
                  >
                    ...
                    <a
                      ...
                      className='px-1 text-sm font-bold italic  text-red-600 '
                    >
        ...
        <div className='col-span-2'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 my-5'>
            {serviceIcons.map((icon) => (
              <div
                className='rounded bg-white shadow border py-2 transition-transform transform hover:scale-105 shadow-md'
                key={icon.id}
              >
