    ...
    <>
      <Helmet>
        <title>
          ...
          Hyderabad Showroom | Maruti Suzuki New Car Offers 2024, Discounts &
          Deals in Hyderabad| Saboo RKS
        </title>
        <meta
          name='title'
          content='Discover Exclusive Maruti Suzuki Car Deals at our Somajiguda,
          Hyderabad Showroom | Maruti Suzuki New Car Offers Febraury 2024, Discounts &
          Deals in Hyderabad| Saboo RKS'
        />
        <meta
          name='description'
          content='Maruti Suzuki New Exclusive Offers Febraury 2024, discounts & deals in Hyderabad. Get exclusive offers and discounts on your favourite Maruti cars from Saboo RKS authorized Maruti Suzuki dealer in Hyderabad. Visit now your nearest Saboo RKS showroom for on going offers. Call now.'
        />
        <meta
          name='keywords'
      ...
      <div className='my-10 text-center space-y-2'>
        <p className='text-blue-900 font-semibold text-2xl'>
            ...
            <div className='flex-auto bg-white'>
              <div>
                ...
                <div className='flex flex-col w-full px-5 mb-3'>
                  <Link
                    to={item.explore}
                    className='bg-blue-900 rounded-full text-white text-center font-bold uppercase py-2 hover:animate-pulse hover:bg-red-700'
                  >
                    View
                  </Link>
                </div>
