...
function Awards() {
  const awardsData = [
    ...
    },
    {
      ...
      title:
        'Maruti Suzuki Best Performance Training Status Service - Saboo RKS',
    },
    {
  ...
  return (
    <>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 container mx-auto my-10 px-5'>
        {awardsData.map((award, index) => (
          ...
          >
            ...
            />
            <div className='p-4'>
              <p className='text-gray-800 font-medium text-md mb-2 text-center'>
                {award.title}
              </p>
            </div>
          </div>
