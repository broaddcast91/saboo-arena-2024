...
export function CardDefault({ cardData }) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios
        .post('https://arena-backend-zj42.onrender.com/accessories', {
          name: name,
          phone: phone,
          // email: email,
          // model: model,
      ...
      <div className='flex flex-col mt-6 lg:w-72 md:w-1/4 w-full h-auto rounded-lg m-4 transform transition duration-500 hover:scale-105 shadow-lg bg-white'>
        ...
        <div className='p-4'>
          ...
          <div className='mt-4 flex items-center justify-between'>
            ...
            <button
              onClick={() => setOpen(true)}
              className='bg-blue-700 text-white py-2 px-4 rounded-full hover:bg-blue-500 focus:outline-none  focus:ring-blue-900 active:bg-blue-700 transition duration-300'
            >
              Buy Now
            </button>
          </div>
              ...
              >
                ...
                >
                  ...
                  <input
                    ...
                    name='LDTuvid'
                  /> */}
                  <Dialog.Panel className='relative bg-white rounded-3xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full'>
                          ...
                          <div className='mt-2 py-8 space-y-3'>
                            ...
                            <div>
                              ...
                              <select
                                ...
                                value={title}
                                defaultValue={title}
                                className='block w-full py-2 px-3  border-gray-300 bg-white rounded-full shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm'
                              >
