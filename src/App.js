      ...
      <Transition.Root show={open} as={Fragment}>
        ...
        >
          <div className='flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0'>
            ...
            >
              <div className='relative inline-block align-bottom bg-gray-100 rounded-3xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-xl sm:w-full'>
                <div className='bg-gray-100 px-4 pt-4  sm:m-1 sm:pb-4'>
                  <div className='text-left'>
                    ...
                    /> */}
                    <h4 className='text-center text-gray-900 font-normal text-xl '>
                      ...
                      <span className='text-blue-900 font-medium text-2xl'>
                        ...
                        <span className='text-red-700 font-semibold hover:font-bold hover:underline'>
            ...
            >
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-4'>
                <div>
                  ...
                  <input
                    className='border h-10 outline-none px-3 rounded-full w-full focus:ring-blue-800 focus:border-blue-800'
                ...
                <div>
                  ...
                  <select
                    ...
                    className='block w-full h-10 py-2 px-3 border border-gray-300 bg-white rounded-full shadow-sm focus:outline-none focus:ring-blue-800 focus:border-blue-800 sm:text-sm'
                  >
              ...
              <div className='text-gray-900 mb-7 p-2 text-xs italic'>
                ...
                <button
                  ...
                  className={`h-10 inline-flex justify-center mr-3 py-2 px-4 mt-4 mb-2 border border-transparent shadow-sm text-sm font-medium rounded-full text-white ${
                    !checkFormValidity()
                      ...
                      : 'bg-blue-800 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500'
                  }`}
                >
                  {loading ? (
